...
if (internationalnewsData.length===0) return <p style={{margin:"50px",textAlign:"center",fontSize:"25px"}}>News Loading...</p>  


const firstArticle=internationalnewsData[0]
const nextThreearticles=internationalnewsData.slice(1,4)
const remainingArticles=internationalnewsData.slice(4)
