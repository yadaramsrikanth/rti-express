...
const AboutUs=()=>{
    ...
    <div className="about-profile">
      ...
      <div className="about-details">
        ...
        <img src={baba_image} alt="Kotipalli Baba" className="profile-image-large" />

            </div>
          </div>
          <img src={baba_image} alt="Kotipalli Baba" className="profile-image-small" />
        </div>
      </div>
        ...
        <div className="profile-header">
          <div className="text-info">
            ...
            <p>
              ...
              <img src={naik_image} alt="S. Ramachandra Naik" className="profile-image-large" />

            </div>
          </div>
          <img src={naik_image} alt="S. Ramachandra Naik" className="profile-image-small" />
        </div>
      </div>
      ...
      <div className="about-details">
        <div className="profile-header">
          <div className="text-info">
            ...
            <img src={imran_image} alt="Dr. M. Imran Ali Khan" className="profile-image-large" />

            </div>
          </div>
          <img src={imran_image} alt="Dr. M. Imran Ali Khan" className="profile-image-small" />
        </div>
      </div>
          ...
          <div className="text-info">
            ...
            <p>
              ...
              activists.
                      ...
                      <img src={shankar_image} alt="D. SivaShankar" className="profile-image-large" />


            </div>
          </div>
          <img src={shankar_image} alt="D. SivaShankar" className="profile-image-small" />
        </div>
      </div>
</div>
      ...
      <div className="about-details">
        <div className="profile-header">
          <div className="text-info">
            ...
            <img src={shobarani_image} alt="shoba rani" className="profile-image-large" />

            </div>
          </div>
          <img src={shobarani_image} alt="shoba rani" className="profile-image-small" />
        </div>
      </div>
</div>
