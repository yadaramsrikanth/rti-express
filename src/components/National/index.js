...
if (nationalnewsData.length===0) return <p style={{margin:"50px",textAlign:"center",fontSize:"25px"}}>News Loading...</p>  


const firstArticle=nationalnewsData[0]
const nextThreearticles=nationalnewsData.slice(1,4)
const remainingArticles=nationalnewsData.slice(4)
